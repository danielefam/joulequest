...
def build_argument_parser():
    ...
    parser.add_argument("--min_active_samples", type=int, default=100)
    parser.add_argument("--warmup_inferences", type=int, default=20)
    ...
    parser.add_argument("--calibration_initial_inferences", type=int, default=20)
    parser.add_argument("--calibration_target_seconds", type=float, default=1.0)
    parser.add_argument("--calibration_repetitions", type=int, default=8)
    ...
    parser.add_argument("--trailing_idle_seconds", type=float, default=30.0)
